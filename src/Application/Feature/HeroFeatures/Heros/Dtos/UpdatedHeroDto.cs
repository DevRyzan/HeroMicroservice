...
public class UpdatedHeroDto
{
    ...
    public UpdatedHeroDto()
    {

    }
    public UpdatedHeroDto(Guid id, string name, string region, DifficultLevel difficultLevel, bool status, HeroType heroType, string description, string title, string story, double gamPrice, double creditPrice, int heroDetailId)
    {
        Id = id;
        Name = name;
        Region = region;
