...
public class GetListHeroQueryRequest : IRequest<GetListResponse<HeroListModel>>//, ICachableRequest//, ISecuredRequest
{
    public PageRequest PageRequest { get; set; }
    //public string CacheKey => $"GetListHeroQueryRequest ({PageRequest.Page},{PageRequest.PageSize})";
